...
export const mockListings: Listing[] = [
  {
    ...
    category: 'Strategy',
    categories: ['Strategy', 'Family', 'Negotiation'],
    condition: 'Like New',
  ...
  {
    id: 'gloomhaven-request',
    title: 'Gloomhaven',
    category: 'Strategy',
    categories: ['Strategy', 'Co-op', 'Role Playing'],
    condition: 'Good',
    listingPurpose: 'request',
    listingType: 'wanted',
    availability: 'available',
    requestOptions: ['rent', 'borrow'],
    ownerId: 'seed-owner-4',
    ownerName: 'Jamie Park',
    createdAt: 1716680800000,
    updatedAt: 1716680800000,
    location: 'Downtown',
    meetupPreferences: 'Evenings or weekends',
    description:
      'Looking to try Gloomhaven before committing to the full box. Happy to borrow for a week or rent for a longer campaign.',
    imageUrls: [],
  },
]
